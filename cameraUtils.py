...
def reconstruct(colorL, colorR, bgL, bgR, imprefixL, imprefixR, thresh, threshC, camL, camR):
    """
    ...
    maskLDiff = objectL - backgroundL 
    maskLDiff = maskLDiff * maskLDiff 
    maskLDiff = np.sum(maskLDiff, axis = 2) 
    maskLDiff = np.sqrt(maskLDiff) 
    
    maskRDiff = objectR - backgroundR 
